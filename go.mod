...
// Fix oras-go v1.2.6 compatibility with docker types
// oras-go v1.2.6 expects docker v27.x types but go-containerregistry pulls v28+
replace github.com/docker/docker => github.com/docker/docker v27.1.2+incompatible

replace github.com/docker/cli => github.com/docker/cli v27.1.2+incompatible
...
require github.com/rancherlabs/slsactl v0.1.11
