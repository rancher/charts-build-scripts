...
func (b *Bump) calculateNextVersion() error {
	util.Log(slog.LevelInfo, "calculate next version")
	...
	util.Log(slog.LevelDebug, "", slog.String("latestVersion", b.versions.latest.txt))
	util.Log(slog.LevelDebug, "", slog.String("latestRepoVersion", b.versions.latestRepoPrefix.txt))
	util.Log(slog.LevelDebug, "", slog.String("toReleaseVersion", b.versions.toRelease.txt))
	util.Log(slog.LevelDebug, "", slog.String("toReleaseRepoVersion", b.versions.toReleaseRepoPrefix.txt))
	util.Log(slog.LevelInfo, "calculated bump", slog.String("version", b.Pkg.AutoGeneratedBumpVersion.String()))
	return nil
}
