...
func (b *Bump) calculateNextVersion() error {
	logger.Log(slog.LevelInfo, "calculate next version")
	...
	logger.Log(slog.LevelDebug, "", slog.String("latestVersion", b.versions.latest.txt))
	logger.Log(slog.LevelDebug, "", slog.String("latestRepoVersion", b.versions.latestRepoPrefix.txt))
	logger.Log(slog.LevelDebug, "", slog.String("toReleaseVersion", b.versions.toRelease.txt))
	logger.Log(slog.LevelDebug, "", slog.String("toReleaseRepoVersion", b.versions.toReleaseRepoPrefix.txt))
	logger.Log(slog.LevelInfo, "calculated bump", slog.String("version", b.Pkg.AutoGeneratedBumpVersion.String()))
	return nil
}
