...
Introducing a new package usually requires three things: creating a directory under `packages` and filling in a `package.yaml`.
...
If you need to make additional changes after testing, repeat steps 3-7. Otherwise, you are ready to make a PR!
